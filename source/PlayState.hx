...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch(songLowercase)
		{
			...
			case 'helper' | 'pressure' | 'potential':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/' + songLowercase + '/dialogue'));
		}
				...
				case 'Valley1':
					{
						defaultCamZoom = 0.8;
						curStage = 'valley1';
						var bg:FlxSprite = new FlxSprite(-300, -200).loadGraphic(Paths.image('Valley/NushValley1'));
						bg.antialiasing = FlxG.save.data.antialiasing;
				...
				case 'Valley2':
					{
						defaultCamZoom = 0.8;
						curStage = 'valley1';
						var bg:FlxSprite = new FlxSprite(-300, -200).loadGraphic(Paths.image('Valley/NushValley2'));
						bg.antialiasing = FlxG.save.data.antialiasing;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
				...
				case 'Valley3':
					{
						defaultCamZoom = 0.8;
						curStage = 'valley3';
						var bg:FlxSprite = new FlxSprite(-300, -200).loadGraphic(Paths.image('Valley/NushValley3'));
						bg.antialiasing = FlxG.save.data.antialiasing;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
				...
				case 'arcade':
					{
						defaultCamZoom = 0.8;
						curStage = 'arcade';
						var bg:FlxSprite = new FlxSprite(-500, -250).loadGraphic(Paths.image('sunset'));
						bg.antialiasing = FlxG.save.data.antialiasing;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
